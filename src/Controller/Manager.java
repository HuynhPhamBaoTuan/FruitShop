...
public class Manager {
    public void displayCreatedFruit(ArrayList<Fruit> fr_list){
        for(Fruit fr: fr_list){
            fr.print();
        }
    }
    
    public void displayOrderList(ArrayList<Order> ord_list) {
        int id=1;
        double total = 0;
    ...
    public void displayShopFruit(ArrayList<Fruit> fr_list){
    ...
    public boolean checkFruitbyItem(int item, ArrayList<Fruit> fr_list){
    ...
    public boolean inputValidQuantity(int valid_item, ArrayList<Fruit> fr_list, int input_quantity){
